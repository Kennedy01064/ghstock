  ...
  <div v-else-if="order" class="space-y-8 pb-32">
    ...
    <div class="card flex flex-col md:flex-row md:items-center justify-between gap-8 border-white/[0.12] shadow-[0_32px_64px_-12px_rgba(0,0,0,0.6)] backdrop-blur-3xl overflow-hidden relative group/header">
      ...
      <div class="flex items-center gap-6 relative z-10">
        <div class="h-14 w-14 rounded-2xl bg-navy-accent border border-white/[0.12] flex items-center justify-center text-amber shadow-[inset_0_2px_4px_rgba(255,255,255,0.05)]">
        ...
        <div v-if="order.status === 'draft' && criticalInventory.length" class="p-8 rounded-[2.5rem] bg-red-950/20 border border-red-500/20 shadow-[0_24px_48px_-12px_rgba(153,27,27,0.3)] backdrop-blur-xl">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
            <article v-for="inv in criticalInventory" :key="inv.id" class="bg-white/[0.05] border border-white/[0.07] rounded-2xl p-4 flex items-center gap-4">
              <div class="w-14 h-14 shrink-0 bg-navy-deep border border-white/[0.07] flex items-center justify-center rounded-xl p-2 shadow-2xl">
