          ...
          <form class="px-8 py-6 space-y-5" action="/auth/login" method="post" @submit.prevent="handleLogin">
            ...
            <div class="space-y-1">
              ...
              <div class="relative group/input">
                ...
                <input data-testid="login-username" v-model="form.username" type="text" name="username" autocomplete="username" placeholder="Nombre de Usuario" class="input-field !pl-14 !bg-white/[0.05] !text-white" />
              </div>
            </div>
            ...
            <div class="space-y-1">
              ...
              <div class="relative group/input">
                ...
                <input data-testid="login-password" v-model="form.password" :type="showPassword ? 'text' : 'password'" name="password" autocomplete="current-password" placeholder="Password Institucional" class="input-field !pl-14 !pr-14 !bg-white/[0.05] !text-white" />
