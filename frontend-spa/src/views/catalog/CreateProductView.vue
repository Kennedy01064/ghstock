<template>
  <div class="max-w-[1320px] mx-auto space-y-12 pb-32 px-4">
    <div class="flex flex-col gap-6 border-b border-slate-200 pb-10">
    ...
    <div class="max-w-2xl">
        ...
        <form class="space-y-6" @submit.prevent="submitForm">
          ...
          <div class="space-y-3">
            ...
            <div v-if="productPreview" class="flex items-center gap-6 p-4 rounded-2xl bg-slate-50 border border-slate-200 w-fit">
              <img :src="productPreview" alt="Preview" class="h-24 w-24 object-cover rounded-xl shadow-lg border border-slate-200">
              <div class="space-y-1">
          ...
          <div class="pt-10 flex flex-col md:flex-row gap-4 border-t border-slate-200">
      ...
      <div class="flex items-center gap-4 p-5 rounded-2xl bg-slate-50 border border-slate-200 mt-6">
        <div class="h-10 w-10 flex items-center justify-center rounded-xl bg-white border border-slate-200 text-amber shrink-0">
