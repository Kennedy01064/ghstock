<template>
  <div class="max-w-2xl mx-auto space-y-8 pb-20 px-4">
      ...
      <form class="space-y-6" @submit.prevent="submitForm">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div class="space-y-1">
            ...
            <div class="relative group">
              <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <span class="text-slate-900/20 font-black group-focus-within:text-amber transition-colors">@</span>
              </div>
        ...
        <div class="space-y-2">
          ...
          <div class="relative">
            ...
            <ul v-if="roleMenuOpen && authStore.currentRole === 'superadmin'" class="absolute z-50 w-full mt-3 bg-white border border-slate-200 rounded-2xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] overflow-hidden backdrop-blur-xl">
              <li>
    ...
    <div class="p-5 rounded-2xl bg-slate-50 border border-slate-200 flex items-start gap-4">
      ...
      <div class="space-y-1">
        <p class="text-xs font-black text-slate-900 uppercase tracking-widest">Protocolo de Seguridad</p>
